...
const chapters = [
  ...
  '06-cache-busting-and-invalidation.md',
  '07-hq-extensions-and-cache.md',
  '08-cache-settings-talks-and-field-notes.md',
  '09-small-local-cache-example-with-tags.md',
  '10-storage-providers-and-media-caching.md',
  '11-future-hybrid-cache-architecture.md',
  '12-nucache-vs-hybrid-cache.md',
